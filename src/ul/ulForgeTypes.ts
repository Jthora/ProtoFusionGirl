// ulForgeTypes.ts
// Mirror of @ul-forge/core type definitions.
// When @ul-forge/core is published on npm, these types can be replaced by:
//   import type { Gir, ValidationResult, ... } from '@ul-forge/core/types';
//
// Source: https://github.com/Jthora/universal_language/blob/main/ul-forge/packages/core/src/types.ts
...
// ── Type aliases to match @ul-forge/core naming ──
// The real package exports Node/Edge; these aliases preserve backward compatibility.
export type { GirNode as Node, GirEdge as Edge };
...
// ── Layout geometry types (for game engine rendering, NOT SVG) ──
