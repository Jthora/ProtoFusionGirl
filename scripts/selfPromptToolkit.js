...
// Toolkit for processing self_prompt_queue.json and extending the AI self-prompt pipeline

// Change file extension to .cjs for CommonJS compatibility if running in a 'type: module' project
...
function processNextPrompt() {
  ...
  // Simulate processing: mark as complete and move to history
...
function help() {
  console.log(`Self-Prompt Toolkit Usage:\n` +
    `  node scripts/selfPromptToolkit.js list         # List all prompts in the queue\n` +
    `  node scripts/selfPromptToolkit.js process      # Process the next prompt in the queue\n` +
    `  node scripts/selfPromptToolkit.js processAll   # Process all prompts in the queue\n` +
    `  node scripts/selfPromptToolkit.js clear        # Clear all prompts from the queue\n` +
    `  node scripts/selfPromptToolkit.js history      # Show processed prompt history\n` +
    `  node scripts/selfPromptToolkit.js help         # Show this help message\n`);
}
